...
FORMATTERS_CHECK_COMMANDS: Dict[Formatter, FormatCommand] = {
    config.formatter: FormatCommand(
        formatter, config.file_filter, config.get_format_container_fn, config.format_commands, export_formatted_code=False
    )
...
FORMATTERS_FIX_COMMANDS: Dict[Formatter, FormatCommand] = {
    config.formatter: FormatCommand(
        formatter, config.file_filter, config.get_format_container_fn, config.format_commands, export_formatted_code=True
    )
    for config in FORMATTERS_CONFIGURATIONS
}
